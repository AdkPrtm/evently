                    ...
                    <div className="flex w-full flex-col gap-8 p-5 md:p-10">
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                                <div className="flex gap-3">
                                    ...
                                    <p className="p-medium-16 rounded-full bg-grey-500/10 px-4 pt-2.5 text-grey-500">{event.category.name}</p>
                                </div>
                        ...
                        <div className="flex flex-col gap-5">
                            <div className="flex gap-2 md:gap-3">
                                ...
                                <div className="p-medium-16 lg:p-reguler-20 flex flex-wrap items-center">
                            ...
                            <div className="p-reguler-20 flex items-center gap-3">
                                <Image src={'/assets/icons/location.svg'} alt="locationIcon" width={32} height={32} />
